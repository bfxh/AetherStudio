...
impl EditorState {
    ...
    pub(super) fn get_file_vector_icon(&self, name: &str) -> Option<crate::icons::IconKind> {
        ...
        match ext.as_str() {
            ...
            "js" | "mjs" | "cjs" => Some(IconKind::FileJs),
            "ts" => Some(IconKind::FileTs),
            ...
            "dart" => Some(IconKind::FileDart),
            "hs" | "lhs" => Some(IconKind::FileHaskell),
            "vue" => Some(IconKind::FileVue),
            "jsx" | "tsx" => Some(IconKind::FileReact),
            "svelte" => Some(IconKind::FileSvelte),
            "zig" => Some(IconKind::FileZig),
            "r" => Some(IconKind::FileR),
            "scala" | "sc" => Some(IconKind::FileScala),
            "pl" | "pm" => Some(IconKind::FilePerl),
            "clj" | "cljs" | "cljc" => Some(IconKind::FileClojure),
            "ex" | "exs" => Some(IconKind::FileElixir),
            "erl" | "hrl" => Some(IconKind::FileErlang),
            "jl" => Some(IconKind::FileJulia),
            "fs" | "fsx" | "fsi" => Some(IconKind::FileFSharp),
            _ => None,
        }
    }
